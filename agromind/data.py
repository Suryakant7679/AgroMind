...
DOMAINS = [
    {
        ...
        "tools": [
            ...
            },
            {
                ...
                "description": "Get practical farm guidance with crop context, local conditions, pest plans, schedules, and scheme questions.",
                "accepts": ["chat"],
                "fields": [
                    {"name": "question", "label": "Farming question", "type": "textarea", "placeholder": "How do I manage aphids organically in okra?"},
                    {"name": "adviceType", "label": "Advice type", "type": "select", "options": ["General farm advice", "Pest or disease plan", "Irrigation guidance", "Organic farming", "Crop schedule", "Government scheme guidance"]},
                    {"name": "crop", "label": "Crop", "type": "text", "placeholder": "Okra, wheat, tomato, paddy..."},
                    {"name": "location", "label": "Location", "type": "text", "placeholder": "Village/city/state or coordinates"},
                    {"name": "season", "label": "Season", "type": "select", "options": ["Not sure", "Kharif", "Rabi", "Zaid", "Perennial"]},
                    {"name": "farmStage", "label": "Crop stage", "type": "select", "options": ["Not sure", "Before sowing", "Seedling", "Vegetative", "Flowering", "Fruiting", "Harvest", "Post-harvest"]},
                    {"name": "constraints", "label": "Constraints", "type": "textarea", "placeholder": "Budget, water availability, organic only, labor limits, symptoms noticed..."},
                ],
                "output_hints": ["Situation summary", "Likely causes", "Action plan", "Schedule", "Irrigation or inputs", "Risk alerts", "Follow-up questions"],
            },
            {
                ...
                "fields": [
                    ...
                    {"name": "crop", "label": "Crop name", "type": "text", "placeholder": "Tomato, Wheat, Rice, Sugarcane..."},
                    {"name": "farmSize", "label": "Farm size / Land size", "type": "text", "placeholder": "e.g., 2 acres or 1.5 hectares"},
                    {"name": "soilType", "label": "Soil type", "type": "select", "options": ["Alluvial", "Black", "Red", "Laterite", "Sandy", "Clay"]},
                    {"name": "irrigation", "label": "Irrigation availability", "type": "select", "options": ["Low", "Moderate", "High", "Rainfed"]},
                    {"name": "season", "label": "Season", "type": "select", "options": ["Kharif", "Rabi", "Zaid", "Perennial"]},
                    {"name": "npk_n", "label": "Nitrogen (N) value (optional ppm)", "type": "number", "placeholder": "e.g., 45"},
                    {"name": "npk_p", "label": "Phosphorus (P) value (optional ppm)", "type": "number", "placeholder": "e.g., 30"},
                    {"name": "npk_k", "label": "Potassium (K) value (optional ppm)", "type": "number", "placeholder": "e.g., 20"},
                    {"name": "location", "label": "Location (City/Village/Coordinates)", "type": "text", "placeholder": "e.g., Pune, Maharashtra or 18.52, 73.85"},
                    {"name": "irrigationMethod", "label": "Irrigation method", "type": "select", "options": ["Drip Irrigation", "Sprinkler", "Flood Irrigation", "Rainfed", "Manual"]},
                    {"name": "sowingDate", "label": "Sowing date", "type": "date", "placeholder": "YYYY-MM-DD"},
                    {"name": "state", "label": "State", "type": "text", "placeholder": "e.g., Maharashtra"},
                    {"name": "marketDistrict", "label": "Market / District", "type": "text", "placeholder": "e.g., Pune Mandi"},
                ],
                "output_hints": ["Fertilizer Recommendation & Dosage", "Irrigation Schedule & Planning", "Weather Alerts & Stress Warnings", "Estimated Harvest Date", "Seed Recommendations & Disease Suitability", "Live Mandi Prices & Price Predictions"],
            },
            {
    ...
    },
    {
        ...
        "tools": [
            ...
            },
            {
                ...
                "description": "Get safe wellness guidance, habit plans, nutrition support, fitness routines, sleep/stress help, and care escalation signs.",
                "accepts": ["chat"],
                "disclaimer": MEDICAL_DISCLAIMER,
                "fields": [
                    {"name": "question", "label": "Health question", "type": "textarea", "placeholder": "Create a simple sleep improvement plan."},
                    {"name": "supportType", "label": "Support type", "type": "select", "options": ["General wellness", "Nutrition plan", "Fitness routine", "Sleep improvement", "Stress management", "Medication safety question", "When to seek care"]},
                    {"name": "age", "label": "Age", "type": "number", "placeholder": "28"},
                    {"name": "sex", "label": "Sex", "type": "select", "options": ["Prefer not to say", "Female", "Male", "Other"]},
                    {"name": "goal", "label": "Goal", "type": "text", "placeholder": "Better sleep, weight control, manage stress..."},
                    {"name": "conditions", "label": "Known conditions or medicines", "type": "textarea", "placeholder": "Diabetes, asthma, pregnancy, blood pressure medicines, allergies..."},
                    {"name": "routine", "label": "Current routine", "type": "textarea", "placeholder": "Diet, activity, sleep timing, work schedule, symptoms..."},
                ],
                "output_hints": ["Safety disclaimer", "Personalized wellness plan", "Do and avoid list", "Daily routine", "Red flags", "Follow-up questions"],
            },
            {
    ...
    },
    {
        ...
        "tools": [
            ...
            },
            {
                "id": "ai-tutor-chat",
                "title": "AI Tutor Chat",
                "description": "Learn concepts with step-by-step explanations, examples, practice questions, quizzes, and revision plans.",
                "accepts": ["chat"],
                "fields": [
                    {"name": "question", "label": "Doubt", "type": "textarea", "placeholder": "Explain quadratic equations step by step."},
                    {"name": "learningGoal", "label": "Learning goal", "type": "select", "options": ["Understand concept", "Solve a problem", "Prepare for exam", "Make notes", "Practice quiz", "Create revision plan"]},
                    {"name": "classLevel", "label": "Class/level", "type": "text", "placeholder": "Class 8, NEET, beginner Python..."},
                    {"name": "subject", "label": "Subject", "type": "text", "placeholder": "Math, biology, history, programming..."},
                    {"name": "difficulty", "label": "Difficulty", "type": "select", "options": ["Simple", "Medium", "Advanced", "Exam-focused"]},
                    {"name": "studentContext", "label": "What you already know", "type": "textarea", "placeholder": "I know linear equations but get confused by factoring..."},
                ],
                "output_hints": ["Concept map", "Step-by-step explanation", "Worked examples", "Common mistakes", "Practice quiz", "Revision checklist"],
            },
            {
                "id": "essay-grader",
                "title": "Essay Grader",
